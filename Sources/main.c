...
***********************************************************************
 ...
 Team Members:
   ...
   - Peripheral Leader: Sophia Yuqin Duan    Signature: Sophia Yuqin Duan
...
***********************************************************************
 ...
 1. PWM -- spinning the turn-table motor

 2. ATD -- converting analog music signal into digital

 3. PWM -- reconstructing the digital signal into a waveform.

 4. TIM -- ATD sampling

 5. SPI -- LED Display of time
...
void main(void) {
 ...
 /* < start of your main loop > */
  ...
  int i = 0;
   ...
   /* This part is written to test ATD */
   /*for (i=0; i < 10; i++){
    ...
    */
    ...
    //This line was to test the intensity of the music singal
      /*
      //out = ATDDR0H; //output digital signal on PTT0
      avgout = out + avgout;
      m++;
...
interrupt 7 void RTI_ISR(void)
{
    ...
    //push button samples for testing app-specific functions
    //no need on the actual product
